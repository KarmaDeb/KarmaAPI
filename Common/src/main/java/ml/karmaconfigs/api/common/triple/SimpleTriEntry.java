 ...
 */
public class SimpleTriEntry<A, B, C> implements TriEntry<A, B, C> {
     ...
     */
    public SimpleTriEntry(final A a, final B b, final C c) {
        key = a;
        value = b;
        secondary = c;
    }
    ...
    public String toString() {
        return "SimpleTryEntry@" + hashCode() + "[" + key + ";" + value + ";" + secondary + "]";
    }
}
