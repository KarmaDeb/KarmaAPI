 ...
 */
class PropertyNumber extends PropertyValue<Number> {

    private Number val = 0;
    private String name = "";
     ...
     */
    public PropertyNumber(final TrackerFlag fl) {
        flag = fl;
    }
     ...
     */
    @Override
    public PropertyValue<Number> setIdentifier(final String n) {
        name = n;
        return this;
    }
