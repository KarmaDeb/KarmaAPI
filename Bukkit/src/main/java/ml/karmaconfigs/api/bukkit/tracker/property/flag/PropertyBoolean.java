 ...
 */
class PropertyBoolean extends PropertyValue<Boolean> {
     ...
     */
    public PropertyBoolean(final TrackerFlag fl) {
        flag = fl;
    }
     ...
     */
    @Override
    public PropertyValue<Boolean> setIdentifier(final String n) {
        name = n;
        return this;
    }
